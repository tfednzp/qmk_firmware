...
//#ifdef UNICODE_H
  ...
  [_HIRAGANA] = LAYOUT_atreus_wrapper(
    ________________JIS_L1_____________________,                   ________________JIS_R1_____________________,
    ________________JIS_L2_____________________,                   ________________JIS_R2_____________________,
    ________________JIS_L3_____________________,                   ________________JIS_R3_____________________,
    ________________BOTTOM_L4__________________, ____THUMBS_R4___, ________________BOTTOM_R4__________________
  ),
